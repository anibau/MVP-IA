...
const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const{token , token_access, message}= response.data;
      const tokenFinal= token || token_access;
      // Simulate API call
      if(tokenFinal){
        ...
        toast.error("Credenciales incorrectas o respuesta inesperada");
        ...
        <div className="hidden md:block md:flex-1 bg-secondary/50 relative overflow-hidden">
          ...
          <div className="absolute inset-0 flex items-center justify-center p-10">
            <div className="glass-card max-w-md text-center animate-float">
              ...
              <h3 className="text-xl font-bold mb-2">Fuel Your Creativity</h3>
              <p className="text-muted-foreground">
                Access your personalized inspiration space and unlock your creative potential.
              </p>
            </div>
          </div>
        </div>
